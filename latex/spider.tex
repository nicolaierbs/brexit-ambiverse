...
\title{EU Referendum from the Linguistic Perspective}
\date{\today}
...
\tkzKiviatLine[ultra thick,color=red, fill=black!20,opacity=.5](3.785, 5.31, 5.03, 5.35, 3.99) 
...
\tkzKiviatLine[ultra thick,color=blue,mark=none, fill=blue!20,opacity=.5](5.685, 7.405, 6.135, 5.265, 6.31)
...
\node[draw=none, color=red, font=\Large] at (-1.6,2.8) {Cameron};
\node[draw=none, color=blue, font=\Large] at (6.1,1) {Johnson};
\end{tikzpicture}
